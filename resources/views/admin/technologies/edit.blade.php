...
@section('content')
    <h1 class="py-3">Edit Technology</h1>
    ...
    <form action="{{ route('admin.technologies.update', $technology) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
                aria-describedby="nameHelper" placeholder="Type your technology name here..."
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control @error('technology_image') is-invalid @enderror"
                ...
                placeholder="Type your technology Image here..."
                value="{{ old('technology_image', $technology->technology_image) }}">
            <small id="technology_imageHelper" class="form-text text-muted">Type the technology image max 255
                characters</small>
