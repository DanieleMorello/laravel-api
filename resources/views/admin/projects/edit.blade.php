    ...
    <form action="{{ route('admin.projects.update', $project) }}" method="post">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                rows="3" placeholder="Type your project description here...">{{ old('description', $project->description) }}</textarea>
            @error('description')
                <div class="alert alert-danger" role="alert">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('project_live_url') is-invalid @enderror"
                ...
                placeholder="http://project.dev" value="{{ old('project_live_url', $project->project_live_url) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('project_source_code') is-invalid @enderror"
                ...
                placeholder="http://project.dev" value="{{ old('project_source_code', $project->project_source_code) }}">
